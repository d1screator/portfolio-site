...
const DEFAULT_DESCRIPTION = "Монтаж видео, который нихуя не цепляет. Reels, YouTube, моушн-графика — делаем контент, который смотрят до конца.";
const ADMIN_PASSWORD = "admtmx021";
